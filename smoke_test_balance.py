...
client.post("/student/invoices/generate", data={"fee_category_id": 2, "level": "400", "session": "2025/2026", "payment_plan": "Full Payment"})
resp = client.get("/student/balance")
...
client.post("/student/invoices/generate", data={"fee_category_id": 1, "level": "400", "session": "2025/2026", "payment_plan": "Second Installment"})
with app.app_context():
    db = get_db()
    first = db.execute(
