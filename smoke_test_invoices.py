...
resp = client.post("/student/invoices/generate", data={
    "fee_category_id": dept_fee_id, "level": "400", "session": "2025/2026", "payment_plan": "Full Payment",
...
resp = client.post("/student/invoices/generate", data={
    "fee_category_id": dept_fee_id, "level": "400", "session": "2025/2026", "payment_plan": "First Installment",
}, follow_redirects=True)
resp = client.post("/student/invoices/generate", data={
    "fee_category_id": dept_fee_id, "level": "400", "session": "2025/2026", "payment_plan": "Second Installment",
}, follow_redirects=True)
with app.app_context():
    db = get_db()
    first = db.execute(
...
resp = client.post("/student/invoices/generate", data={
    "fee_category_id": str(other_dept_fee_id), "level": "400", "session": "2025/2026", "payment_plan": "Full Payment",
}, follow_redirects=True)
